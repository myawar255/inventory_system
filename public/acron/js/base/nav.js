...
class Nav {
    ...
    constructor(element, options = {}) {
        ...
        if (window.innerWidth <= 599) {
            ...
            $('.logo_large').show()
            setTimeout(function () {
                $('.logo_large').css('background-position', 'left')
            }, 100);
        }
    }
    ...
    _onMouseEnter(event) {
        ...
        if (
            ...
            this.#timer = setTimeout(function () {
                console.log("INSIDE ENTER MOUSE TIMEOUT");
                $('.logo_small').hide()
                $('.logo_large').show()
            }, 200);
    ...
    _onMouseLeave(event) {
        ...
        if (
            ...
            // Hide .logo_large immediately

            // Wait for 3 seconds before showing .logo_small
            this.#timer = setTimeout(function () {
                console.log("INSIDE EXIT MOUSE TIMEOUT");
                $('.logo_large').hide();
                $('.logo_small').show();
            }, 200);
    ...
    _showMobileMenu(event) {
        event.preventDefault();
        setTimeout(function () {
            $('.logo_large').css('background-position', 'center')
        }, 100);
        console.log("hi its menu click");
